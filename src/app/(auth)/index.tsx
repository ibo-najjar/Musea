...
function FloatingIcon({
	...
	return (
		<Animated.View
			...
			className="rounded-3xl overflow-hidden border-continuous shadow-2xl"
		>
			<Image
				source={icon.source}
...
function SlideScreen1() {
	return (
		<View className="flex-1 justify-center items-center flex-row relative gap-1.5 pt-12 px-5">
			<View className="w-1/2 h-full gap-1">
				...
				<Screen1Card
					isGlass
					source={require("@/assets/onboarding/card1.png")}
				/>
			...
			<View className="w-1/2 h-full gap-2">
				...
				<Screen1Card
					isGlass
					source={require("@/assets/onboarding/card8.png")}
				/>
...
function SlideScreen2() {
	...
	return (
		<View className="flex-1 items-center flex-col relative gap-1.5 pt-12">
			<View className="bg-surface-tertiary h-[200] w-full">
				<Image
					source={require("@/assets/onboarding/post1.jpeg")}
					style={{ width: "100%", height: "100%" }}
					contentFit="contain"
				/>
			</View>
			<View className="flex-row items-center px-5 w-full gap-4 justify-between">
				<View className="flex-row items-center gap-4">
					<View className="flex-row items-center gap-1">
						<SymbolView
							...
							weight={"medium"}
						/>
						<Text className="text-xs font-medium">2,345</Text>
					</View>
					<View className="flex-row items-center gap-1">
						<SymbolView
							name={"bubble"}
			...
			<View className="bg-surface-tertiary h-[185] w-full">
				<Image
					source={require("@/assets/onboarding/post2.jpeg")}
					style={{ width: "100%", height: "100%" }}
					contentFit="contain"
				/>
			</View>
			...
			<TouchableGlass
				// glassEffectClassName="bg-surface/50"
			...
			>
				<View className="flex-row items-center gap-2">
					<ShareScreenItem
						imageSource={require("@/assets/onboarding/post1.jpeg")}
					/>
					<Typography.Heading type="h5">Card 1</Typography.Heading>
				</View>
...
const ShareItemWrapper = ({
	...
	return (
		<View className="items-center gap-1">
			{children}
			{label && (
				<Text className="text-[10px] font-medium max-w-10 text-center h-8">
					{label}
				</Text>
			)}
		</View>
...
const ShareScreenItem = ({
	...
	return (
		<View
			className={cn(
				"size-12 bg-surface-secondary rounded-2xl overflow-hidden items-center justify-center",
...
function PhoneScreen({
	...
	return (
		...
		>
			...
			/>
			<ScreenContent />
			<View className="absolute w-full top-2 right-0 left-0">
				<Image
					source={require("@/assets/onboarding/statusbar.png")}
...
function OnboardingScreen({ onComplete }: { onComplete: () => void }) {
	...
	return (
		...
		>
			...
			<OnboardingButtons scrollX={scrollX} onComplete={onComplete} />
		</View>
	);
}
